...
| Parameter         | Value                                   |
| ----------------- | --------------------------------------- |
| Channels          | 3 active (reported as 4 to PulseView)   |
...
5. **Speed**: `115200`
6. Click **"Scan for devices"** → `ESP32` with 4 channels should appear.
...
- **Channel count**: PulseView sees 4 channels, but only the lower 3 (CH0–CH2) carry real data.
