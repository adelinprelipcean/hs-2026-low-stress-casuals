...
#define PULSEVIEW_MAX_SAMPLE_RATE 80000000

// define uart port - default port
#ifdef CONFIG_ANALYZER_USE_SUMP

#define SUMP_UART_PORT_NUM CONFIG_ANALYZER_UART_PORT_NUMBER
#define SUMP_TEST_TXD CONFIG_ANALYZER_UART_PORT_TX_PIN
#define SUMP_TEST_RXD CONFIG_ANALYZER_UART_PORT_RX_PIN
#define SUMP_UART_BAUD_RATE CONFIG_ANALYZER_UART_PORT_BAUD_RATE
