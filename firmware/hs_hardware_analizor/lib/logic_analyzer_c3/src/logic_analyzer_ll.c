...
static void logic_analyzer_ll_set_clock(int sample_rate)
{
   ...
   // Clock source is always APB (80 MHz) on ESP32-C3 GPSPI2.
   // spi_ll_set_clk_source() does not exist in this SDK version;
   // the default APB source is correct and requires no register write.
